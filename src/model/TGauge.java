...
public class TGauge extends Region {
    ...
    private static final double TIME_TO_VALUE = 1500;
    private static final double FRACTION = 5;
    ...
    // ******************** Constructors **************************************
    public TGauge() {
        getStylesheets().add(getClass().getResource("/resources/style/tgauge.css").toExternalForm());
        getStyleClass().add("tgauge");
        aspectRatio = DEFAULT_HEIGHT / DEFAULT_WIDTH;
        pane = new Pane();
        unitString = new SimpleStringProperty("°C");
        sections = FXCollections.observableArrayList();
        value = new SimpleDoubleProperty(-10);
        minValue = new SimpleDoubleProperty(-10);
        maxValue = new SimpleDoubleProperty(50);
        minMeasuredValue = new SimpleDoubleProperty(-10);
        maxMeasuredValue = new SimpleDoubleProperty(50);
        threshold = new SimpleDoubleProperty(20);
